  ...
  <div>
    ...
    >
      ...
      <el-scrollbar>
        ...
        >
          <span
            >This will overwrite your previous records for this chapter.<br> Continue?</span
          >
          <template #footer>
...
export default {
  ...
  methods: {
    ...
    // saveRecords() {
    //   var _this = this;
    //   var url = "/apis/saveAllModuleQuiz/";
    ...
    async getQuiz(){
      var _this = this;
      var url = "/apis/getAllModulesQuiz/";
